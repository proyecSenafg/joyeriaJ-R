...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2022 a las 21:28:57
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `diferencia_ventas` (IN `fecha1` CHAR(10), IN `fecha2` CHAR(10))  SELECT((SELECT SUM(total) AS suma1 FROM ventas WHERE fecha LIKE concat('%',fecha1,'%')) - (SELECT SUM(total) AS suma2 FROM ventas WHERE fecha LIKE concat('%',fecha2,'%'))) AS difecrencia$$

--
-- Funciones
--
CREATE DEFINER=`root`@`localhost` FUNCTION `suma_ventas` (`fecha_venta` CHAR(10)) RETURNS INT(20) BEGIN
DECLARE suma_ventas int;
SELECT SUM(total) INTO suma_ventas FROM ventas WHERE fecha LIKE concat('%',fecha_venta,'%');
RETURN suma_ventas;
END$$
...
(10, 'Ximena Restrepo', 436346346, 'ximena@gmail.com', '(543) 463-4634', 'calle 45 # 23 - 45', '1956-03-04', 21, '2022-01-15 16:13:30', '2022-01-15 21:13:30'),
...
(12, 'Gonzalo Pérez', 436346346, 'gonzalo@yahoo.com', '(235) 346-3464', 'Carrera 34 # 56 - 34', '1967-08-09', 24, '2017-12-25 17:24:24', '2022-01-15 21:12:45');
...
(58, 5, '515', 'Coche llanta neumatica', 'vistas/img/productos/515/174.jpg', 16, 420, 588, 4, '2022-01-15 21:13:30'),
(59, 5, '516', 'Cono slump', 'vistas/img/productos/516/228.jpg', 14, 140, 196, 6, '2022-01-15 21:13:30'),
(60, 5, '517', 'Cortadora de Baldosin', 'vistas/img/productos/517/746.jpg', 12, 930, 1302, 8, '2022-01-15 21:13:30');
...
(1, 'Administrador', 'admin', '$2a$07$asxx54ahjppf45sd87a5auXBm1Vr2M1NV5t/zNQtGHGpS5fFirrbG', 'Administrador', 'vistas/img/usuarios/admin/191.jpg', 1, '2022-11-16 15:24:51', '2022-11-16 20:24:51'),
(57, 'Luis Carlos Toncel Oliveros', 'luis', '$2a$07$asxx54ahjppf45sd87a5auwx8lyuZ.kds4dac831wJ6GwzvInb.wG', 'Vendedor', 'vistas/img/usuarios/juan/461.jpg', 1, '2022-11-16 15:26:37', '2022-11-16 20:26:37'),
(58, 'Julio Gómez', 'julio', '$2a$07$asxx54ahjppf45sd87a5aub5nGP0VwzLwk9mYKNeU59ocPXY/HdwK', 'Especial', 'vistas/img/usuarios/julio/100.png', 1, '2022-11-16 11:52:39', '2022-11-16 16:52:39'),
(59, 'Ana Gonzalez', 'ana', '$2a$07$asxx54ahjppf45sd87a5auLd2AxYsA/2BbmGKNk2kMChC3oj7V0Ca', 'Vendedor', 'vistas/img/usuarios/ana/260.png', 1, '2017-12-26 19:21:40', '2022-11-16 16:51:33');
...
(39, 10002, 10, 1, '[{\"id\":\"60\",\"descripcion\":\"Cortadora de Baldosin\",\"cantidad\":\"1\",\"stock\":\"12\",\"precio\":\"1302\",\"total\":\"1302\"},{\"id\":\"59\",\"descripcion\":\"Cono slump\",\"cantidad\":\"1\",\"stock\":\"14\",\"precio\":\"196\",\"total\":\"196\"},{\"id\":\"58\",\"descripcion\":\"Coche llanta neumatica\",\"cantidad\":\"1\",\"stock\":\"16\",\"precio\":\"588\",\"total\":\"588\"}]', 396.34, 2086, 2482.34, 'Efectivo', '2022-01-15 21:13:30');
